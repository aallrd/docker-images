pipelineJob('docker-images/rhel/6.4/rhel-6.4-conan-gcc7') {

    description('Build the RHEL 6.4 conan GCC 7 image')
    ...
    definition {
        cps {
            script(readFileFromWorkspace('rhel/6.4/conan/gcc7/Jenkinsfile'))
            sandbox()
        }
    }
