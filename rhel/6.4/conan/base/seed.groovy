pipelineJob('docker-images/rhel/6.4/rhel-6.4-conan-base') {

    description('Build the RHEL 6.4 conan base image')
    ...
    definition {
        cps {
            script(readFileFromWorkspace('rhel/6.4/conan/base/Jenkinsfile'))
            sandbox()
        }
    }
}
